# type: ignore
"""https://raw.githubusercontent.com/ContinualAI/avalanche/master/avalanche/training/plugins/lwf.py
...
class LwFPlugin(StrategyPlugin):
    ...
    def before_backward(self, strategy, **kwargs):
        ...
        penalty = self.penalty(strategy.mb_output, strategy.mb_x, alpha, strategy.model)
